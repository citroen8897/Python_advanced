...
def main():
    ...
    try:
        a_start = int(
            input("Задайте начало диапазона для первого " "коефициента: ")
        )
        a_fin = int(
            input("Задайте конец диапазона для первого " "коефициента: ")
        )
        b_start = int(
            input("Задайте начало диапазона для второго " "коефициента: ")
        )
        b_fin = int(
            input("Задайте конец диапазона для второго " "коефициента: ")
        )
        c_start = int(
            input("Задайте начало диапазона для третьего " "коефициента: ")
        )
        c_fin = int(
            input("Задайте конец диапазона для третьего " "коефициента: ")
        )
            ...
            for b in range(b_start, b_fin + 1):
                for c in range(c_start, c_fin + 1):
                    if b ** 2 - 4 * a * c >= 0:
                        ...
                        print(
                            f"Уравнение с коефициентами {a}, {b}, {c} "
